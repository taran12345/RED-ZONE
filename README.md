...
Security has become an essential aspect of everyday life in India. One of the way in which we can provide the security is by enabling people with vital inforamtion on the security aspects for the route they would take during the travel from one place to another. “Red Zone” trained the model using multi-class logistic regression, will predict which route is safe for user to travel and also flagged cities as Red(risk), Yellow(moderate safe), Green(safe).The profiling of data coulod be done based on history of crimes in the area, presence of people, security guards, presence of surveillance cameras, no of vehicle in the area at tha given time.
